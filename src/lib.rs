...
//!
//! # or
//! resman = { version = "0.17.2", features = ["debug"] }
//! resman = { version = "0.17.2", features = ["fn_res"] }
//! resman = { version = "0.17.2", features = ["fn_res", "fn_res_mut"] }
//! resman = { version = "0.17.2", features = ["fn_res", "fn_meta"] }
//! resman = { version = "0.17.2", features = ["fn_res", "fn_res_mut", "fn_meta"] }
//!
//! # requires nightly
//! resman = { version = "0.17.2", features = ["fn_res", "fn_res_mut", "fn_res_once"] }
//! ```
//!
//! In code:
//!
